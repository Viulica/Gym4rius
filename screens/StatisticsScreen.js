...
import ExercisePicker from '../components/ExercisePicker'; // Import the ExercisePicker component
import { ExerciseContext } from './ExerciseContext'; // Import the ExerciseContext

const StatisticsScreen = ({ navigation, workouts = [] }) => {
  const { predefinedExercises } = useContext(ExerciseContext); // Use the context
