...
const NewWorkoutScreen = ({ navigation }) => {
    ...
    const saveCustomExercise = () => {
        ...
        if (customExercise.name && customExercise.type && customExercise.bodyPart) {
            ...
            setPredefinedExercises([...predefinedExercises, newExercise]);
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <ExerciseCard
                        ...
                        onDeleteExercise={deleteExercise} // Pass deleteExercise to ExerciseCard
                    />
                )}
...
const styles = StyleSheet.create({
    ...
    input: {
        ...
        borderRadius: 5,
        width: '100%',
        color: '#000',  // Ensuring the text is visible
    },
    placeholderTextColor: '#333',  // Making placeholder text more visible
    buttonRow: {
        flexDirection: 'row',
        justifyContent: 'space-between',
        marginTop: 20,
